...
export default function FloatingLines({
  ...
  let resolvedGradient = linesGradient;
  if (!resolvedGradient && (gradientStart || gradientMid || gradientEnd)) {
    resolvedGradient = [];
    if (gradientStart) resolvedGradient.push(gradientStart);
    if (gradientMid) resolvedGradient.push(gradientMid);
    if (gradientEnd) resolvedGradient.push(gradientEnd);
  }
