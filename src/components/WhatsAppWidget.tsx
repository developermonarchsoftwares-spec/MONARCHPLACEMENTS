...
export default function WhatsAppWidget() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-12 h-12 rounded-full border border-white/15 bg-black/80 text-white backdrop-blur-md shadow-glow-sm hover:border-white/40 hover:shadow-glow-md transition-all duration-300 group"
